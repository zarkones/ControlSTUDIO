...
func (m mainTheme) Color(name fyne.ThemeColorName, variant fyne.ThemeVariant) color.Color {
	...
	case theme.ColorNamePrimary, theme.ColorNameInputBorder, theme.ColorNameSeparator, theme.ColorNameScrollBar:
		return COLOR_PRIMARY

	case theme.ColorNameSelection, theme.ColorNameHover:
		return TRANSPARENT
